    	...
    	<div class="wrap">
            ...
            <?php echo $this->get_slideshow( false );?>
                    ...
                    <ul class="property-data">
                        ...
                        <?php if( ! empty( $this->get_the_ppsf() ) ):?><li><span>PRICE/ SQ FEET:</span> <?php echo $this->get_the_ppsf();?></li><?php endif;?>
                       ...
                       <?php if ( ! empty( $agent_contact ) ):?>
                        ...
                        <?php endif;?>
						<?php if( ! empty( $this->get_field('Colisting_Agent') ) ):?>
						<li><span>CO-LISTING AGENT:</span> <?php echo $this->get_field('Colisting_Agent');?></li>
						<?php endif;?>
                    </ul>
