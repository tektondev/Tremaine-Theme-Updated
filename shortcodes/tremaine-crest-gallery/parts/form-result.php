<li class="tre-gallery-card person-card">
	<a href="<?php echo $link;?>">
    	<img class="tre-image grayscale" src="<?php echo WOVAXTREMAINEURL;?>/shortcodes/tremaine-crest-gallery/images/spacer3-4.gif" style="background-image:url(<?php echo $image;?>);background-position:center;background-size:cover;background-repeat:no-repeat">
    </a>
